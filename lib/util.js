...
(function () {
   ...
   var random = module.exports.random = function (key, seed) {
      random_numbers[key] = (random_numbers[key] || new MersenneTwister(seed))
      return random_numbers[key].random();
   };
   ...
   var random_angle = module.exports.random_angle = function (key, seed) {
      return random(key, seed) * FULL_ANGLE;
   };
   ...
   var detect_collision = module.exports.detect_collision = function (current_pos, previous_pos, target_pos, target_radius) {
